...
public class ColourImageView extends ImageView implements Serializable {
...
//                        float count = 0;
//                        for (int i = 0; i < 100; i++) {
//                            Bitmap temp = Bitmap.createBitmap(bm);
//                            count += 0.01;
//                            temp.setWidth((int) (bm.getWidth() * count));
//                            temp.setHeight((int) (bm.getHeight() * count));
//                            setImageDrawable(new BitmapDrawable(getResources(), temp));
//                        }
    ...
    private void initStack() {
        ...
        stacksize = sharedPreferences.getInt("stack_max_size", 50);
